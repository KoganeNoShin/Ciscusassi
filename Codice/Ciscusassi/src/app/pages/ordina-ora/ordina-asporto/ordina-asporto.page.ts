...
import { IonButton, IonCard, IonCol, IonContent, IonGrid, IonHeader, IonImg, IonInput, IonRadio, IonRow, IonText, IonTitle, IonToolbar, IonDatetime, IonModal, IonDatetimeButton, IonItem, IonLabel, IonList, IonCardHeader, IonCardTitle, IonCardContent } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonCardContent, IonList, IonItem, IonDatetimeButton, IonModal, IonDatetime, IonInput, IonContent, CommonModule, FormsModule, IonGrid, IonRow, IonCol, IonImg, IonCard, IonText, IonButton]
})
...
selectPlace(place: any) {
  this.selectedAddress = place.address.freeformAddress || place.address.streetName || '';
  this.selectedCoords = {
