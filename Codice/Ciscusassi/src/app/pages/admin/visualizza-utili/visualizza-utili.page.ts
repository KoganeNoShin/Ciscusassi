...
import { IonButton, IonCol, IonContent, IonGrid, IonHeader, IonInput, IonRow, IonSelect, IonSelectOption, IonTitle, IonToolbar } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonInput, IonButton, IonGrid, IonRow, IonCol,IonSelect, IonSelectOption]
})
...
rows = [
  { address: 'Via Vincenzo Piazza Martini, 45', values: Array(12).fill('- €') },
