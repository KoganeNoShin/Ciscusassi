...
class Filiale {
    ...
    static async create({ id_filiale, comune, indirizzo, num_tavoli, longitudine, latitudine, immagine }) {
        return new Promise((resolve, reject) => {
            db.run('INSERT INTO filiali (id_filiale, comune, indirizzo, num_tavoli, longitudine, latitudine, immagine) VALUES (?, ?, ?, ?, ?, ?, ?)', [id_filiale, comune, indirizzo, num_tavoli, longitudine, latitudine, immagine], function (err) {
                if (err)
                    reject(err);
